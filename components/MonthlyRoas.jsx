    ...
    <div>
      <div className="mb-4 flex items-center gap-4">
        <div className="text-sm text-gray-500">
          Comparing <span className="font-semibold text-gray-700">{data.previousLabel || 'Previous Month'}</span>
          {' '}vs{' '}
          <span className="font-semibold text-gray-700">{data.currentLabel} MTD</span>
        </div>
        ...
        <table className="min-w-full text-sm">
          <thead>
            <tr className="bg-gray-800 text-white">
              ...
              <th className="px-3 py-3 text-center font-semibold">Prev Month ROAS</th>
              <th className="px-3 py-3 text-center font-semibold">Current MTD ROAS</th>
                ...
                <>
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5 text-right font-semibold text-gray-700">
                      {fmtSpend(catTotalSpend)}
                    </td>
                    <td colSpan={5} className="px-3 py-2.5 text-center text-gray-400 text-xs italic">
      ...
      <p className="mt-3 text-xs text-gray-400">
        ROAS = Revenue (7-day direct GMV) / Spend • CPC Δ% red = cost went up (bad) • CVR Δ% red = conversions dropped (bad)
      </p>
    </div>
  );
}
